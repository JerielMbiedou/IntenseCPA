...
current_dir = "/Users/jeriel/Documents/WS24:25/MA/cpa/results/Kang_Order_2_2"
results_dir = os.path.join(current_dir, "experiment_results")
report_file = os.path.join(results_dir, "final_report_kang_with_std.md")
...
best_intense_row = avg_scores.sort_values("r2_mean_deg", ascending=False).iloc[0]
