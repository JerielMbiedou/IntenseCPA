...
# Define paths based on sciplex3 structure
PROJECT_ROOT = "/home/nmbiedou/Documents/cpa"
ORIGINAL_DATA_PATH = os.path.join(PROJECT_ROOT, "datasets", "sciplex3_new.h5ad")
PREPROCESSED_DATA_PATH = os.path.join(PROJECT_ROOT, "datasets", "sciplex3_new_preprocessed.h5ad")
...
EXPERIMENT_NAME = "cpa_autotune_sciplex3"
...
print(result_grid)
with open(os.path.join(PROJECT_ROOT, 'result_grid_sciplex3.pkl'), 'wb') as f:
